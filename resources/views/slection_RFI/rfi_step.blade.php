                    ...
                    <table class="table my-0" id="dataTable">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="text-align: center;"><a href="/id"><button class="btn btn-primary" type="button" style="background: rgb(247,61,61);"><i class="fa fa-eye" style="color: rgb(255,255,255);"></i></button></a></td>
                            </tr>
                        </tbody>
                        <tfoot>
                            <tr>
