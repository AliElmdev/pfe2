    ...
    <section class="clean-block clean-catalog dark">
        ...
        <div class="container">
            <div class="content">
                <div class="row">
                    <div class="col-md-3">
                        <form action="{{ route('Marches') }}" method="GET">
...
>>>>>>> 1bef297d9cc3c0358481614f4ae00a338f631b5b
                                    ...
                                    <div class="filter-item">
                                        ...
                                        <input name="limit_date" type="date" class="form-control" style="width: 100%;">
                                    </div>
                                    <div class="filter-item">
                            ...
                            <form action="{{ route('Marches') }}" method="GET">
                                <div class="collapse" id="filters">
                                    <div class="filters">
                                        <div class="filter-item">
                                            <h3><strong>Domaines</strong></h3>
                                            <select class="chosen form-select" style="color: #000000;width: 100%;"
                                                onchange="(e)=>e.submit()">
                                                <option></option>
                                                @foreach ($list_domaines as $item)
                                                <option value="{{$item->id}}">{{$item->name}}</option>
                                        ...
                                        <div class="filter-item">
                                            ...
                                            <select class="chosen form-select" style="color: #000000;width: 100%;">
                                                <option></option>
                                                @foreach ($list_categories as $item) <option value="{{$item->id}}">
                                                    {{$item->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
