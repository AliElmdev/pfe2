...
<main class="page catalog-page">
    <section class="clean-block clean-catalog dark">
        <div class="block-heading"
            style="background: linear-gradient(rgba(0,0,0,0.33) 0%, #000000), url(&quot;assets/img/mining-exploration-activities.jpg&quot;);height: 230px;width: 100%;">
                        ...
                        <div class="d-md-none"><a class="btn btn-link d-md-none filter-collapse"
                            ...
                            <div class="collapse" id="filters">
                                <div class="filters">
                                    <div class="filter-item">
                                        <h3><strong>Domaines</strong></h3>
                                        <select class="chosen form-select" required=""
                                            style="color: #000000;width: 100%;">
                                            <option></option>
                                            @foreach ($list_domaines as $item)
                                            <option value="{{$item->id}}">{{$item->name}}</option>
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-12 col-md-6 col-lg-4 marche_{{$item->id_categorie}} domain_{{$value->id_domaine}}"
                                    ...
                                    <div class="clean-product-item" style="width: 100%;height: 230px;">
                                        <h5 style="font-weight: bold;">{{$item->categories}}</h5>
                                        <p>Objet :{{$item->title}}</p>
                                        <p style="font-size: 15px;">Dossier_{{$item->id}}: {{$item->description}}<br>
                                        </p>
                                        <div class="d-flex">
                                        ...
                                        <div style="height: 20%;margin-left: 70%;margin-top: 10px;">
                                            <a href={{route('marchesunitere',$item->id)}} style="background:
                                                var(--bs-blue);color: rgb(255,255,255);padding-right: 20px;padding-left:
                                                20px;padding-bottom: 10px;padding-top: 10px;border-radius: 6px;">
                                                Accéder
                                            </a>
                                        </div>
                                        <hr
