...
<main class="page">
    <section>
        <section style='margin-bottom: 65px; background : #c13335;'>
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-8 ml-auto mr-auto mb-4" style="width: 100%; padding-right: 5%; padding-left: 5%;">
                            <div class="multisteps-form__progress">
                                <a class="btn multisteps-form__progress-btn js-active" role="button" title="User Info">Étape 1</a>
                                <a class="btn multisteps-form__progress-btn" role="button" title="User Info">Étape 2</a>
                                <a class="btn multisteps-form__progress-btn" role="button" title="User Info">Étape 3</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="multistep-start-row" class="row">
                    <div id="multistep-start-column" class="col-12 col-lg-8 m-auto" style="width: 100%;">
                        <form id="main-form" class="multisteps-form__form" method="POST" action="{{ route("registration") }}" enctype="multipart/form-data">
                            @csrf
                            <div id="single-form-next" class="multisteps-form__panel shadow p-4 rounded bg-white js-active" data-animation="scaleIn" style="background: linear-gradient(57deg, #e8e8e8eb, #bfbfbfe0), var(--bs-blue);">
                                <div id="form-content" class="multisteps-form__content">
                                    <div id="input-grp-double" class="form-row mt-4">
                                        ...
                                        <div class="col-12 col-sm-6" style="width: 100%;">
                                            ...
                                            <div class="d-flex" style="width: 100%; margin-bottom: 10px;">
                                                <span style="color: rgb(0, 0, 0); width: 50%;">Dénomination sociale :&nbsp;</span>
                                                <input class="form-control" type="text" style="width: 50%;" name="social_name" />
                                            </div>
                                            <div class="d-flex" style="width: 100%; margin-bottom: 10px;">
                                            ...
                                            <div class="d-flex" style="width: 100%; margin-bottom: 10px;">
                                                ...
                                                <select class="form-select" style="width: 50%;" name="company_type">
                                                    <optgroup label="Forme juridique">
                                                        <option value="Société de personnes" selected="">Société de personnes</option>
                                                        ...
                                                        <option value="Société à réglementation particulière">Société à réglementation particulière</option>
                                                    </optgroup>
                                                </select>
                                            </div>
                                            <div class="d-flex" style="width: 100%; margin-bottom: 10px;">
                                        ...
                                        <div class="col-12 col-sm-6" style="width: 100%;">
                                            <div class="d-flex" style="width: 100%; margin-bottom: 10px;">
                                                ...
                                                <select class="form-select" style="width: 10%;" name="title">
                                                    <optgroup label="Titre">
                                                        ...
                                                        <option value="Mlle">Mlle</option></optgroup>
                                                </select>
                                            </div>
                                            <div class="d-flex" style="width: 100%; margin-bottom: 10px;">
                                            ...
                                            <div class="d-flex" style="width: 100%; margin-bottom: 10px;">
                                                ...
                                                <select class="form-select" style="width: 30%;" name="service_title">
                                                    <optgroup label="Titre/Service">
                                                        <option value="Autre" selected="">Autre</option>
                                                        <option value="Propriétaire">Propriétaire</option>
                                                        <option value="Chef de projet">Chef de projet</option>
                                                        <option value="Service Commercial/Marketing">Service Commercial/Marketing</option>
                                                        <option value="Département Production">Département Production</option>
                                                        <option value="Département Projet">Département Projet</option>
                                                        <option value="Département Achat">Département Achat</option>
                                                        <option value="Professionnel/Consultant">Professionnel/Consultant</option>
                                                        <option value="Représentant légal">Représentant légal</option>
                                                        <option value="Président">Président</option>
                                                        <option value="Vice-président">Vice-président</option>
                                                        <option value="Dirigeant unique">Dirigeant unique</option>
                                            ...
                                            <div class="d-flex" style="width: 100%; margin-bottom: 10px;">
                                                ...
                                                <select class="form-select" style="width: 50%;" name="lang">
                                                    <optgroup label="Choix de la langue"><option value="12" selected="">English</option><option value="13">Francais</option><option value="14">عربي</option></optgroup>
                                                </select>
                                            </div>
                                            <div class="d-flex" style="width: 100%; margin-bottom: 10px;">
                                                <span style="color: rgb(0, 0, 0); width: 50%;">Fuseau horaire :<br /></span>
                                                <select class="form-select" style="width: 50%;">
                                                    <optgroup label="Fuseau horaire">
                                                        <option value="UTC" selected="">UTC</option><option value="UTC+01:00">UTC+01:00</option><option value="UTC+02:00">UTC+02:00</option>
                                                    </optgroup>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div id="next-button" class="button-row d-flex mt-4">
                                        <button
                                            ...
                                            type="button"
                                            title="Next"
                                            style="background: #c13335; width: 20%; min-width: 70px; max-width: 800px; margin-right: 40%; margin-left: 40%; border-width: 0px;"
                            ...
                            <div id="single-form-next-prev" class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="scaleIn" style="background: linear-gradient(57deg, #e8e8e8, #bfbfbf);">
                                <h3 class="text-center multisteps-form__title" style="color: var(--bs-red);font-weight: bold;">À propos</h3>
                                <div id="form-content-2" class="multisteps-form__content">
                                    ...
                                    <div id="next-prev-buttons-1" class="button-row d-flex mt-4">
                                        <button
                                            ...
                                            type="button"
                                            title="Prev"
                                            style="background: #c13335; width: 20%; min-width: 70px; max-width: 800px; margin-left: 30%; border-width: 0px;margin-right: 5px;"
                                            onclick="window.location.href=&#39;#progress-bar-button&#39;"
                                        >
                                        Précédent
                                        </button>
                                        <button
                                            ...
                                            type="button"
                                            title="Next"
                                            style="background: #c13335; width: 20%; min-width: 20px; max-width: 800px; margin-right: 30%; border-width: 0px;"
                                            onclick="window.location.href=&#39;#progress-bar-button&#39;"
                                        >
                                            Suivant
                                        </button>
                            ...
                            <div id="single-form-next-prev-1" class="multisteps-form__panel shadow p-4 rounded bg-white" data-animation="scaleIn" style="background: linear-gradient(57deg, #e8e8e8, #bfbfbf);">
                                ...
                                <p style="overflow-y: scroll; height: 277px;">
                                    Ces Conditions d'Accessibilité, de Disponibilité et de Sécurité du Portail («CADSP») décrivent les termes des services fournis par ESO SA («ESO») à travers le Portail suivant les Conditions
                                    ...
                                    intégrante.Les CADSP sont applicables à tous les services qui sont sous la responsabilité d'ESO, c'est-à-dire toutes lestransactions engagées derrière ses pare-feux1&nbsp;et ses relais
                                    ...
                                    <br />
                                    <strong>1. Accessibilité du Portail</strong>Le Portail Fournisseurs est accessible à travers Internet https://esuppliers.ESOgroup.org Le Fournisseur reconnaìt que le caractère public de l'Internet
                                    empèche ESO de garantir :<br />
                                    ...
                                    Dans le cas de pannes matérielles qui ne sont pas bloquantes mais qui altèrent l'exercice de l'Utilisateur, ESO s'engageà faire ses meilleurs efforts pour prendre en compte et réparer ces pannes.
                                    <br />
                                    ...
                                    Le service peut en particulier ètre interrompu pour des opérations de maintenance.► Règles ESO concernant le mot de passe<br />
                                    Un compte d'accès au Portail est créé par Fournisseur, le mot de passe est envoyé directement par le système de ESO eachat@ESOgroup.ma à l'adresse E-mail de l' «Utilisateur Autorisé».<br />
                                    ...
                                    <br />
                                    ESO informera les Utilisateurs Fournisseurs via le Portail En cas de travaux de maintenance planifiés durant les heures entre 8h et l6h -heure marocaine- pour les jours ouvrables du Lundi au
                                    Vendredi.<br />
                                    Dans la mesure du possible, la maintenance sera exécutée durant une période de moindre gène.<br />
                                    Le Fournisseur reconnaìt qu'ESO n'est pas responsable et ne serait en aucun cas tenu de lui verser des dommages et Intérèts du fait de l'interruption, de la suspension, de la modification ou de
                                    l'abandon du Portail ou d'un des Services.3. Sécurité et confidentialitéESO a défini et mis en reuvre une politique de sécurité concernant l'échange de données avec des partenaires externes, basée
                                    sur une évaluation suivant la disponibilité, l'intégrité, la confidentialité, la pérennité et le système d'audit.<br />
                                    Le niveau de sécurité fourni par le réseau d'accès au portail fournisseurs peut ètre suffisant ou nécessiter une mise à niveau qui sera définie et décidée par ESO.<strong>4. Compléments</strong>►
                                    Gestion des changements<br />
                                    ESO se réserve le droit de modifier et mettre à jour à tout moment les CADSP.<br />
                                    ESO s'efforcera, autant que possible, d'en informer les Utilisateurs. Ces modifications et mises à jour s'imposent à l'Utilisateur qui doit en conséquence se référer régulièrement à cette
                                    rubrique, au niveau du portail, pour vérifier lesCADSP en vigueur.<br />
                                    • Changements dans /es Services<br />
                                    ESO adopte un dialogue étroit avec les Fournisseurs et leurs représentants dans le cadre d'une démarche qualité. Tout nouveau service ou toute évolution de fonctionnalités du Portail ou de ces
                                    ...
                                    ESO met à la disposition du Fournisseur une assistance par voie de messagerie électronique et au travers les adresses e- mail spf@ESOgroup.ma pour le portail I Supplier et une assistance pour le
                                    portail Appels d'offres à travers l'adresses e-mail support-eAchats-ESO@bravosolution.fr ou via a la hotline en appelant le numéro ci-après :• Si le fournisseur est au Maroc : 0800003636<br />
                                    ...
                                    du Fournisseur.<br />
                                    L'Assistance ESO fera le maximum pour répondre aux demandes des différents utilisateurs.<br />
                                    La responsabilité de l'Assistance ne comprend pas la résolution ou la correction de pannes révélées dans des produits, services ou infrastructures non ESO.
                                    <strong>MENTIONS LEGALES1. IDENTIFICATION</strong>Le présent site accessible à l'adresse https://esuppliers.ESOgroup.org est édité par ESO SA, 2 rue Al Abtal-Hay Erraha, Casablanca,
                                    Maroc.L'hébergement du Portail est assuré par ESO SA.L'accès au Portail ainsi que l'utilisation de son contenu s'effectuent dans le cadre des mentions d'utilisation décrites dans les Conditions
                                    d'Accès et d'Utilisation (CAU).<strong>2. DONNEES A CARACTERE PERSONNEL</strong>ESO est le seul responsable du traitement des données à caractère personnel collectées sur le Portail.
                                    ...
                                    naissance, adresses e-mail et postales, ville, Etat) que les Fournisseurs sont susceptibles de fournir à ESO SA dans le cadre de demande d'information. Ces données, quelle qu'en soit la nature,
                                    permettent -directement ou indirectement- àESO SA d'identifier les Fournisseurs et de leur adresser des informations par voie électronique.Ces données sont collectées dans le but exclusif
                                    ...
                                    Les données à caractère personnel sont conservées par ESO SA pendant une période raisonnable.<strong>2.2 Consentement</strong>Aucune donnée à caractère personnel n'est collectée sans le
                                    consentement des Fournisseurs.<br />
                                    La nature facultative ou obligatoire des mentions à communiquer à ESO SA dans ce cadre serapréalablement indiquée aux Fournisseurs. Ces derniers ne sont aucunement contraints de transmettre à ESO
                                    ...
                                    personnelles.Ainsi, chaque utilisateur peut exiger auprès du service concerné d'ESO que soit rectifiées, clarifiées, mises à jour ou effacées les informations le concernant qui sont inexactes,
                                    ...
                                    Fournisseurs peuvent adresser un courrier à l'adresse suivante :ESO SA 2, rue A/ Abta/-Hay Erraha Casab/anca20200 MAROC<br />
                                    Ou<br />
                                    • Envoyer un courrier électronique à l'adresse mail spf@ESOgroup.ma en ce qui concerne le portail i Supplier• Pour le portail Appel d'offres, envoyer un courrier électronique à l'adresse e- mail
                                    support-eAchats-ESO@bravosolution.fr ou appeler la hotline au numéro ci- après :o Si le fournisseur est au Maroc : 0800003636<br />
                                    o Si le fournisseur est à l'étranger : +212522924545<strong>3. COPYRIGHT - PROPRIETE INTELLECTUELLE</strong>ESO SA est titulaire des noms de domaine https: //esuppliers.ESOgroup.orgLe Portail dans
                                    ...
                                    constituent des reuvres de l'esprit protégées par la loi.Le Portail ainsi que les éléments qui le composent sont la propriété exclusive de ESO SA, seule habilitée à utiliser les droits de
                                    ...
                                    autorisation expresse<strong>CONDITIONS D'ACCES ET D'UTILISATION DU PORTAIL FOURNISSEURS ESO SA</strong><br />
                                    <strong>ESO SA, le 21/10/20131. Objet</strong>Les présentes conditions d'accès et d'utilisation du Portail Fournisseurs ESO SA (ci- aprèsdésignées les «CAU») ont pour objet de définir les
                                    conditions générales juridiques et techniques régissant l'utilisation par tout Fournisseur d'ESO SA (ci après «ESO») de la partie sécurisée du portail des Fournisseurs d'ESO (ci-après désigné le
                                    «Portail »).On entend par ESO toutes ses filiales et toute société ou entité dont elle détient des participations.Par l'intermédiaire du Portail, ESO met à la disposition du Fournisseur, à titre
                                    gratuit, unenvironnement lui permettant d'accéder à l'outil collaboratif de ESO ci-après désigné l'«Outil»)ainsi qu'à des informations, données, bases de données, sites, systèmes d'information,
                                    applications,etc. de ESO (ci-après désignés les «Services») et destiné à assurer des échanges d'information avec ESO dans le cadre de la réalisation des travaux qui lui sont confiés par ESO, ou de
                                    sollicitation lors d'un Appel d'Offres dans l'objectif d'optimiser les relations entre le Fournisseur et ESO, et ce conformément aux dispositions des CAU.L'ensemble des informations, données,
                                    documents, formules, plans, savoir-faire, idées ou tout autreélément qui feront l'objet des échanges entre ESO et le Fournisseur via le Portail et l'Outil, (ci après respectivement dénommés le
                                    «Contenu ESO » et le «Contenu Fournisseur » et cumulativement le «Contenu ») ne pourront ètre utilisés respectivement par ESO et par le Fournisseur que dans le cadre de leurs relations
                                    ...
                                    critères d'accès au Portail et dont l'accès au Portail est autorisé par ESO.Ci-après, ESO et le Fournisseur sont désignés conjointement par les «Parties » ou individuellement par la « Partie »
                                    <br />
                                    <br />
                                    ...
                                    <strong>2. Accessibilité au Portail</strong>Le Fournisseur ne peut accéder au Portail et l'utiliser que dans le cadre de ses relations avec l'ESO et par l'intermédiaire de ses Utilisateurs
                                    ...
                                    l'informatique, en tant qu'outil de travail.Le nom et les coordonnées de l'Administrateur Fournisseur doivent ètre connus de tous les interlocuteurs d'ESO au sein de sa société, car c'est à
                                    ...
                                    <br />
                                    La Société ne peut procéder à la nomination de plusieurs Administrateurs qu'après un accord expresse et écrit de la part de la direction d'ESO.L'Administrateur Fournisseur est nommé par le
                                    ...
                                    CAU et à saisir en ligne. Ce formulaire sera signé, cacheté et transmis à la direction d'ESO par tous moyens.Le Fournisseur pourra désigner, en cas de besoin, un remplaçant en cas de congés ou
                                    ...
                                    modifications des données concernant un Utilisateur Autorisé, demande d'accès à un Service) directement dans l'annuaire de contròle d'accès fournisseurs de ESO , devra s'équiper d'un mode
                                    d'authentification forte (« Mot de passe aléatoire ») et ESO lui fournira un code d'identification Administrateur Fournisseur (« Code d'Identification») permettant de gérer l'utilisation du
                                    ...
                                    passe / Identifiant Utilisateur leur permettant d'utiliser le Portail.Le représentant légal du Fournisseur doit communiquer et informer ESO sur le transfert ou la fin dela fonction de
                                    l'Administrateur et sur tous événements susceptibles de mettre en question la stabilitéde sa fonction. Le Fournisseur doit automatiquement faire une demande de désactivation de compte,à l'ESO, par
                                    ...
                                    régissant le Portail.L'administrateur sera responsable des conséquences de tous dommages causés à ESO dans le cadre de ses attributions. Il ne peut s'exonérer de sa responsabilité qu'en démontrant
                                    ...
                                    Portail dans les conditions prévues par les présentes. Ils s'engagent également à informer immédiatement ESO en cas de perte ou utilisation frauduleuse d'un Mot de passe /Identifiant Utilisateurs
                                    ...
                                    Portail, de quelque manière que ce soit, en utilisant les Mots de passe / Identifiants Utilisateurs dudit Fournisseur ou de ses Utilisateurs Autorisés.ESO ne sera en aucun cas responsable de la
                                    ...
                                    Utilisateur attribué à un Utilisateur Autorisé est considérée comme étant effectuée par ledit Utilisateur Autorisé et sous sa responsabilité et ESO a le droit de se fier à ces indications et de
                                    ...
                                    techniques d'accès et d'utilisation sont disponibles sur demande auprès d'ESO.<strong>3. Confidentialité et droits de propriété intellectuelle</strong>Les Informations Confidentielles désignent
                                    ...
                                    Portail.Ne seront pas considérer comme des Informations confidentielles toutes les informations portant sur les appels d'offre mis par ESO sur le Portail.<br />
                                    ...
                                    • toute filiale, toute société ou toute entité actuelle ou future dans lequel ESO détient ou détiendra, directement ou indirectement, une participation dans le capital ;<br />
                                    ...
                                    <br />
                                    <strong>4. Protection des données personnelles</strong>Le Fournisseur s'engage à informer les Utilisateurs Autorisés si des données personnelles les concernant ont été communiquées au groupe ESO.
                                    <br />
                                    ...
                                    l'ensemble des opérations effectuées à travers son compte et avec son identifiant et il est entièrement responsable des opérations effectuées par ses employés, agents et représentants.ESO et le
                                    ...
                                    Les échanges de données informatisées entre ESO et le Fournisseur, concerneront, principalement :Les propositions d'articles, les propositions de prix, la création des factures, des avis
                                    ...
                                    L'envoi d'informations par le Fournisseur vaut expression de sa volonté et constitue son engagement vis-à-vis d'ESO.<br />
                                    ...
                                    document papier. A ce titre, ESO et le Fournisseur renoncent à contester l'authenticité des informations échangées ou à opposer ces informations du seul fait de leur échange par voie électronique.
                                    <br />
                                    ...
                                    de sa dignité, ainsi qu'à la protection des mineurs, (f) porter atteinte à l'image de marque interne et externe de ESO et du Groupe ESO, (g) enfreindre les dispositions des CAU.Dans ce cadre, le
                                    ...
                                    autorisation du Portail Fournisseurs par leFournisseur, son Administrateur des comptes Utilisateurs et les Utilisateurs Autorisés, leFournisseur doit indemniser et garantir ESO contre toutes
                                    ...
                                    Portail.<strong>• ESO</strong><br />
                                    ESO mettra en reuvre les moyens permettant au Fournisseur et aux Utilisateurs Autorisés l'accès au Portail conformément aux dispositions des CAU et des CADSP et l'utilisation des Services
                                    conformément aux conditions d'utilisation du service, et conformément aux lois et réglementations en vigueur.<br />
                                    Le Portail peut contenir des liens ou des renvois à d'autres sites internet. ESO n'est pas responsable du contenu de ces autres sites Internet et ne sera pas responsable en cas de dommages
                                    provoqués par le contenu affiché sur ces autres sites Internet ou accessible par leur intermédiaire.<br />
                                    ESO n'avalise pas le Contenu fourni par le Fournisseur ou les Utilisateurs Autorisés. ESO n'est pas obligé de contròler le Contenu du Fournisseur; ce dernier dégage expressément ESO et ses tiers
                                    contractants de toute responsabilité de contròle et de filtrage de ce Contenu.<br />
                                    Cependant; ESO peut, compte tenu des circonstances, prendre toutes les mesures qui lui semblent nécessaires ou appropriées quant au Contenu du Fournisseur. ESO fera ses meilleurs efforts pour que
                                    le Contenu ESO ne comporte pas d'inexactitudes techniques ou des coquilles typographiques ou des virus. Celui-ci peut ètre modifié à intervalles réguliers mais aussi quand ESO le souhaite.ESO
                                    s'efforcera, autant que possible, d'avertir l'Utilisateur des modifications apportées au Contenu ESO.<br />
                                    ESO pourra interrompre, suspendre ou interdire totalement ou en partie l'accès au Portail ou aux Services, sans préavis ni indemnité, si le Fournisseur ou ses Utilisateurs Autorisés ont un
                                    ...
                                    <br />
                                    Compte tenu du niveau de sécurité du Portail, ESO ne pourra ètre tenue responsable de l'accès frauduleux au Portail constituant un délit visé par L'alinéa 3 de l'article 607 du code pénal
                                    marocain.<br />
                                    Sous réserve des garanties définies ci-dessus, le Portail et les Services sont mis à disposition des Fournisseurs par ESO « en l'état ». ESO n'accorde aucune autre garantie concernant notamment
                                    l'adéquation des Services aux besoins du Fournisseur.<br />
                                    ESO et ses fournisseurs de services ne pourront ètre tenus responsables à l'égard du Fournisseur et le cas échéant de tiers des dommages de tous types, directs ou indirects, résultant de l'accès
                                    au Portail et de l'utilisation des Services et du Contenu par le Fournisseur, sauf faute de ESO.<br />
                                    Les dispositions du présent article resteront applicables après la résiliation ou l'expiration des CAU.<strong>7. Durée de validité et résiliation</strong>ESO pourra résilier les CAU ou suspendre
                                    ou limiter à tout moment et à son gré l'accès du Fournisseur au Portail : (a) pour toute raison dès lors que le Fournisseur n'appartient plus au panel des fournisseurs de ESO ou (b) en cas de
                                    ...
                                    immédiatement cesser d'utiliser le Portail, sans préjudice de dommages et intérèts pour ESO.<br />
                                    ...
                                    télécommunications, la défaillance des serveurs de ESO, et tout autre cas indépendant de la volonté expresse de ESO ou du Fournisseur.<br />
                                    <br />
                                    ...
                                    prévenir le Fournisseur en temps utile et pendant les heures de travail normales ESO a le droit de faire un audit périodique de l'utilisation du Portail faite par le Fournisseur, sous réserve du
                                    respect des clauses de confidentialité des présentes, afin de s'assurer que le Fournisseur respecte les présentes CAU<strong>11. Mises à jour des CAU</strong>ESO se réserve le droit de modifier et
                                    mettre à jour à tout moment l'accès au Portail ainsi que les conditions d'utilisation du Portail et des Services. ESO s'efforcera d'en informer les Utilisateurs, notamment par l'intermédiaire du
                                ...
                                <div id="form-content-1" class="multisteps-form__content" style="border-color: rgba(102, 16, 242, 0);">
                                    <div id="next-prev-buttons" class="button-row d-flex mt-4">
                                        <button
                                            ...
                                            type="button"
                                            title="Prev"
                                            style="width: 20%; min-width: 70px; max-width: 800px; margin-left: 30%; background: #c13335; border-width: 0px; border-color: var(--bs-pink); margin-right: 5px;"
                                            onclick="window.location.href=&#39;#progress-bar-button&#39;"
                                        >
                                            Précédant
                                        </button>
                                        <button
                                            ...
                                            type="submit"
                                            title="Next"
                                            style="width: 20%; min-width: 70px; max-width: 800px; margin-right: 30%; background: #c13335; border-width: 0px;">
                                            Envoyer
                                        </button>
                                    </div>
                                </div>
