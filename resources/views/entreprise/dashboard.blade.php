...
<div class="container-fluid">
                ...
                <div class="card-body">
                    <div class="row align-items-center no-gutters">
                        <div class="col me-2">
                            ...
                            <div class="text-uppercase text-success fw-bold text-xs mb-1"><span
                                    style="font-size: 16px;">Marches En Cours de RFI</span></div>
                    ...
                    <div class="row align-items-center no-gutters">
                        <div class="col me-2">
                            <div class="text-uppercase text-warning fw-bold text-xs mb-1"><span
                                    style="font-size: 16px;">Marches En Cours de RFQ</span></div>
  ...
  xhttp.open("GET", '/marche/notificationMessage', true);
  xhttp.send();
}
    </script>
</div>
