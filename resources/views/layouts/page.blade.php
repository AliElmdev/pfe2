...
<body>
    <nav class="navbar navbar-light navbar-expand-lg bg-white clean-navbar">
        <div class="container"><img src="/assets/img/SST_logo.png" style="width: 86px;"><button
                data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span
                    class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item"><a class="nav-link active"
                            href="{{ route('Home') }}"><strong>accueil</strong></a></li>
            ...
            <div class="row justify-content-between">
                <div class="col-sm-4 col-md-3 item">
                    ...
                    <ul>
                        ...
                        <li style="margin-top: 6px;"><a href="#"><img src="assets/img/securiter-dabord-logo.png"
                                    style="width: 49px;">Sécurité D'abord</a></li>
