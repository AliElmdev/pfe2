...
<main class="page contact-us-page">
    <section class="clean-block clean-form dark">
        <div
            style="background: url('/assets/img/mining-exploration-activities.jpg?h=dc36ade610555e720a0ce985e094d36e') top; height: 100px;">
        </div>
        ...
        <div class="text-warning d-flex d-lg-flex flex-row justify-content-end align-self-end"
            ...
            <button class="btn btn-primary" type="button"
                style="margin-right: 9px; background: var(--bs-success);">Modifier</button><button
                class="btn btn-primary" type="submit" style="background: var(--bs-green);">Annuler</button>
        </div>
        ...
        <div style="margin-top: 26px;">
            <h2 style="font-family: Roboto, sans-serif; margin-left: 17px; font-size: 21.128px;"><strong>1. Réponse de
                    qualification (nombre de questions : 0 )</strong><br /></h2>
            <div class="accordion" role="tablist" id="accordion-1">
                <div class="accordion-item">
                    <h2 class="accordion-header panel-title mb-0" role="tab">
                        <button class="accordion-button collapsed collapsed" data-bs-toggle="collapse"
                            data-bs-target="#accordion-1 .item-1" aria-expanded="false"
                            aria-controls="accordion-1 .item-1">
                            <i class="fa fa-comments"></i>&nbsp;1.1&nbsp;Dossier Fournisseur - Données Saisies - Section
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>Votre entreprise possède -elle des listes des postes dangereux&nbsp;
                                                &nbsp;</td>
                                            <td>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header panel-title mb-0" role="tab">
                        <button class="accordion-button collapsed" data-bs-toggle="collapse"
                            ...
                            <i class="fa fa-comments"></i>&nbsp;1.2&nbsp;Dossier Fournisseur - Pièces jointes - Section
                            avec questions VM<br />
                        </button>
                    </h2>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-check"><input class="form-check-input" type="checkbox"
                                                        ...
                                                        for="formCheck-1">Label</label></div>
                                                <div class="form-check"><input class="form-check-input" type="checkbox"
                                                        id="formCheck-3" /><label class="form-check-label"
                                                        for="formCheck-3">Label</label></div>
                                                <div class="form-check"><input class="form-check-input" type="checkbox"
                                                        id="formCheck-2" /><label class="form-check-label"
                                                        for="formCheck-2">Label</label></div>
                                            </td>
                                        </tr>
                                        <tr>
        ...
        <div style="margin-top: 26px;">
            ...
            <div class="accordion" role="tablist" id="accordion-2">
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header panel-title mb-0" role="tab">
                        <button class="accordion-button collapsed collapsed" data-bs-toggle="collapse"
                            data-bs-target="#accordion-2 .item-2" aria-expanded="false"
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header panel-title mb-0" role="tab">
                        <button class="accordion-button collapsed collapsed" data-bs-toggle="collapse"
                            data-bs-target="#accordion-2 .item-3" aria-expanded="false"
        ...
        <div style="margin-top: 26px;">
            <div class="accordion" role="tablist" id="accordion-3">
                <div class="accordion-item">
                    <h2 class="accordion-header panel-title mb-0" role="tab">
                        <button class="accordion-button collapsed collapsed" data-bs-toggle="collapse"
                            data-bs-target="#accordion-3 .item-1" aria-expanded="false"
                            ...
                            <div class="table-responsive"
                                ...
                                <table class="table">
                                    ...
                                    <tbody style="padding-left: 10px;">
                                        <tr>
                                            <td style="padding-top: 11px; padding-left: 19px;">&nbsp; &nbsp; &nbsp;
                                                &nbsp; 1</td>
                                            <td>&nbsp; &nbsp; &nbsp; &nbsp; pc</td>
                                            <td>&nbsp; &nbsp; &nbsp; &nbsp;unité</td>
                                            ...
                                            <td style="border-width: 0px;"><input type="text" style="width: 77.4px;" />
                                            </td>
                                            <td style="border-width: 0px;">...................</td>
                                        </tr>
                                        <tr>
