...
--
-- Host: localhost
-- Generation Time: Feb 25, 2018 at 02:48 PM
...
INSERT INTO `clients` (`id`, `name_client`, `email_client`, `phone_client`, `adresse_client`) VALUES
(1, 'Default Client', 'default@gmail.com', 'default', 'default'),
(2, 'Ahmed', 'ahmed@gmail.com', '0605242170', 'marjane 2 meknes'),
(3, 'Ali', 'ali@gmail.com', '0605296470', 'mansour 8 meknes');
-- --------------------------------------------------------
...
(1, 'POS', 'dashboard', 'dashboard-panel', 'fa fa-home', 1, 1, '2017-06-21 12:30:00', NULL),
(2, 'Gestion Des Utilisateurs', 'user_management', 'user-register', 'fa fa-user', 2, 1, '2017-06-05 22:44:05', '2017-06-05 22:44:05'),
(3, 'Gestion Des Modules', 'module_management', 'module-list', 'fa fa-signal', 3, 1, '2017-06-06 19:38:48', '2017-06-06 19:38:48'),
(4, 'Gestion Des Roles', 'role_management', 'role-list', 'fa fa-eye', 5, 1, '2017-06-06 19:55:09', '2017-06-06 19:55:09'),
(5, 'Gestion Des Permissions', 'permission_management', 'permission-list', 'fa fa-refresh', 4, 1, '2017-06-06 22:27:01', '2017-06-06 22:27:01'),
(6, 'Gestion Des Catégories', 'productcategory_mgmt', 'productcategory-list', 'fa fa-flag', 6, 1, '2017-06-07 18:09:49', '2017-06-07 18:09:49'),
(7, 'Gestion Des Produits', 'product_management', 'product-list', 'fa fa-product-hunt', 7, 1, '2017-06-07 18:11:25', '2017-06-07 18:11:25'),
(8, 'Gestion Des Ventes', 'sales_management', 'sales-create', 'fa fa-shopping-cart', 8, 1, '2017-06-08 19:37:53', '2017-06-08 19:37:53'),
(9, 'Gestion Des Produits Reference', 'productref_management', 'productref-list', 'fa fa-product-hunt', 7, 1, '2017-06-07 18:11:25', '2017-06-07 18:11:25'),
(10, 'Gestion Des Dépenses', 'expenses_management', 'expenses-list', 'fa fa-usd', 10, 1, '2017-06-22 18:52:09', '2017-06-22 18:52:09'),
(14, 'Gestion Des Achats', 'purchase_management', 'purchase-list', 'fa fa-list', 15, 1, '2017-07-07 01:23:47', '2017-07-07 01:23:47'),
(15, 'Transaction Bancaire', 'bank_transaction', 'transaction-list', 'fa fa-list', 17, 1, '2017-07-15 23:41:04', '2017-07-15 23:41:04'),
(16, 'Statistiques', 'statistiques', 'statistique-panel', 'fa fa-bar-chart', 18, 1, '2017-07-15 23:41:04', '2017-07-15 23:41:04');
...
(49, 'Product Reference View', 'productref-list', '2017-07-17 22:32:23', '2017-07-17 22:32:23'),
(50, 'Product Reference Create', 'productref-create', '2017-07-17 22:32:23', '2017-07-17 22:32:23'),
(51, 'Product Reference Edit', 'productref-edit', '2017-07-17 22:32:23', '2017-07-17 22:32:23'),
(52, 'Product Reference Delete', 'productref-delete', '2017-07-17 22:32:23', '2017-07-17 22:32:23'),
(53, 'Product Reference Import', 'productref-import', '2017-07-17 22:32:23', '2017-07-17 22:32:23');
-- --------------------------------------------------------
...
CREATE TABLE `product_references` (
  ...
  `nom_produit_ref` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `code_produit_ref` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `desc_produit_ref` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dosage_produit_ref` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `unit_dasage_produit_ref` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `forme_produit_ref` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `presentation_produit_ref` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `prix_vente_produit_ref` float COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `taux_reboursement_produit_ref` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(3, 4, 'Apple Juce 1 Litter', 'AJ', 50, 48, 600, 1, 'admin', NULL, '2017-10-28 15:29:32', '2018-01-28 13:11:21'),
(4, 4, 'Hard Soda 1 Litter', 'HS1', 70, 70, 300, 1, 'admin', NULL, '2017-10-28 15:31:10', '2017-10-28 15:31:10'),
(5, 5, 'Gillette Razor Blade', 'GRB', 50, 49, 300, 1, 'admin', NULL, '2017-10-28 15:34:01', '2018-01-28 13:11:26'),
...
(13, 1, 9, '2017-06-22 18:52:09', '2017-06-22 18:52:09'),
(14, 2, 9, '2017-06-22 18:52:09', '2017-06-22 18:52:09'),
...
(25, 1, 16, '2017-07-15 23:41:04', '2017-07-15 23:41:04');
...
INSERT INTO `salescarts` (`id`, `product_id`, `quantity`, `price`, `saller_name`, `sales_status`, `sales_date`, `created_at`, `updated_at`) VALUES
(1, 3, 1, 600, 'admin', 1, '2018-01-28 00:00:00', '2018-01-28 13:11:21', '2018-01-28 13:11:21'),
(2, 5, 1, 300, 'admin', 1, '2018-01-28 00:00:00', '2018-01-28 13:11:26', '2018-01-28 13:11:26');
...
(1, 'Grocery System', 'admin', 'nagarikbazar@gmail.com', '$2y$10$XmykG7VgSFgCISNx45xui.4yzNoXIABDohzsFlBByG6EJwhu1EAYm', '2018-01-28 18:55:57', 1, 'lAA65mYOYHBQ08slt5pBG7lwOx2Cuexqu1d21c6vNG7P2cArjtAAsLxszoYb', '2017-06-05 21:35:29', '2018-01-28 13:10:57'),
(2, 'User Admin', 'user', 'nagarikbazar1@testtest.com', '$2y$10$XmykG7VgSFgCISNx45xui.4yzNoXIABDohzsFlBByG6EJwhu1EAYm', '2017-10-29 09:27:32', 1, 't4d8hhkDCOcbq3ASUlkwEHtPb69jZoq16Kl53SpfR9CkHxQd8HW8NwcyghQu', '2017-06-06 19:47:19', '2017-10-29 03:42:32');
